...
namespace Model
{
    public class 父魂 : Converted
    {
        ...
        {
            base.Execute();
            primitives = TimerTask.Instance.Cards[0].PrimiTives;
        }
        ...
        public override void OnEnable()
        {
            ...
            {
                if (i != Src) i.playerEvents.afterDamaged.AddEvent(Src, OnDamaged);
            }
        }
        ...
        public override void OnDisable()
        {
            foreach (var i in SgsMain.Instance.AlivePlayers)
            {
                if (i != Src) i.playerEvents.afterDamaged.RemoveEvent(Src, OnDamaged);
            }
        }
