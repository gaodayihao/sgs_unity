...
namespace Model
{
    public class 龙吟 : Triggered
    {
        ...
        {
            foreach (var i in SgsMain.Instance.AlivePlayers) i.playerEvents.whenUseCard.AddEvent(Src, Execute);
        }

        public override void OnDisable()
        {
            foreach (var i in SgsMain.Instance.AlivePlayers) i.playerEvents.whenUseCard.RemoveEvent(Src, Execute);
        }
        ...
        public async Task Execute(Card card)
        {
            ...
            var card1 = TimerTask.Instance.Cards[0];
    ...
    public class 竭忠 : Triggered, Ultimate
    {
        ...
        public override void OnEnable()
        {
            Src.playerEvents.startPhaseEvents[Phase.Perform].AddEvent(Src, Execute);
        }

        public override void OnDisable()
        {
            Src.playerEvents.startPhaseEvents[Phase.Perform].RemoveEvent(Src, Execute);
        }
